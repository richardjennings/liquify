...
func (s *blockSyntax) CanHaveParent(parent BlockSyntax) bool {
	switch {
	case s.isClauseTag:
...
func (g Grammer) addBlockDef(ct *blockSyntax) {
...
func (g Grammer) AddBlock(name string) blockDefBuilder { // nolint: golint
